...
This project was scaffolded with **rollup**. Switch by editing the
generated `rollup.config.*` file or re-scaffold with a different
bundler:
...
`esm + cjs + umd`. Re-scaffold with `--features=format-esm,format-cjs,format-umd`
